...
print_info ""
print_info "Socket locations (biomeOS standard, XDG compliant):"
print_info "  \${PETALTONGUE_SOCKET}                           (explicit override)"
print_info "  \${XDG_RUNTIME_DIR}/biomeos/petaltongue.sock     (standard)"
print_info "  /tmp/biomeos/petaltongue.sock                    (fallback)"
print_info ""
...
print_info "petalTongue JSON-RPC methods (subset):"
print_info "  visualization.render        - render data with grammar"
print_info "  visualization.render.stream - streaming render"
print_info "  visualization.render.scene  - direct SceneGraph submission"
...
print_info "  capabilities.sensory        - sensory capability matrix"
print_info "  capabilities.sensory.negotiate - tailored matrix negotiation"
print_info "  audio.synthesize            - soundscape synthesis"
