...
if [ -z "$TOADSTOOL_FOUND" ]; then
    ...
    echo "  cd /home/eastgate/Development/ecoPrimals/phase1/toadstool"
...
echo "  cd /home/eastgate/Development/ecoPrimals/phase1/toadstool/showcase/local-capabilities"
