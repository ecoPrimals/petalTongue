...
# 3. Run demo
cd /home/eastgate/Development/ecoPrimals/phase2/petalTongue/showcase/03-inter-primal/01-songbird-discovery
./demo.sh
```
...
```bash
# Start tower A
cd /home/eastgate/Development/ecoPrimals/phase1/songbird/showcase/02-federation
...
### **Deep Dive**:
Read: `/home/eastgate/Development/ecoPrimals/phase1/songbird/showcase/02-federation/README.md`
