...
1. **✅ Copied** to `/path/to/ecoPrimals/phase2/bingoCube/`
...
- `/path/to/petalTongue/crates/petal-tongue-ui/src/app.rs`
...
Then symlink: `ln -s /path/to/ecoPrimals/phase2/bingoCube petalTongue/bingoCube`
