...
# 4. Run demo
cd /path/to/petalTongue/showcase/03-inter-primal/04-toadstool-compute
./demo.sh
```
...
cd /path/to/ecoPrimals/phase1/toadstool/showcase/local-capabilities
./01-native-hello.sh
...
cd /path/to/ecoPrimals/phase1/toadstool/showcase/gpu-universal
./check-gpu.sh
...
### **Deep Dive**:
Read: `/path/to/ecoPrimals/phase1/toadstool/showcase/README.md`
