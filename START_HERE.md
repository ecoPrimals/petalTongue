...
**Updated**: July 26, 2026 (Wave 151c — BTSP ClientHello shipped (12/13), attribute-based mesh topology, 6,589 tests, zero clippy warnings)
...
```bash
cargo test --workspace --all-features           # 6,589 workspace tests
