    ...
    fn offline_cached_topology(&self) -> Vec<TopologyEdge> {
        vec![
            TopologyEdge {
                ...
                to: "primal-beta".into(),
                edge_type: "authenticates".to_owned(),
                capability: None,
                metrics: None,
                label: Some("Auth Flow".to_owned()),
            },
            TopologyEdge {
                from: "primal-gamma".into(),
                to: "primal-alpha".into(),
                edge_type: "discovers".to_owned(),
                capability: None,
                metrics: None,
                label: None,
            },
            TopologyEdge {
                ...
                edge_type: "stores_to".to_owned(),
                capability: None,
                metrics: None,
                label: Some("Data Flow".to_owned()),
            },
            TopologyEdge {
                from: "primal-epsilon".into(),
                to: "primal-gamma".into(),
                edge_type: "queries".to_owned(),
                capability: None,
                metrics: None,
                label: None,
            },
            TopologyEdge {
                ...
                capability: None,
                metrics: None,
                label: Some("Task Execution".to_owned()),
            },
        ]
    }
}
