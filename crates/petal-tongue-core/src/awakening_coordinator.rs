...
impl AwakeningCoordinator {
    ...
    pub async fn run(&self) -> Result<bool> {
        ...
        loop {
            ...
            let events_to_process: Vec<_> = self.timeline.events()
...
mod tests {
    ...
    fn test_timeline_stages() {
        ...
        let stage_transitions: Vec<_> = timeline.events()
            .iter()
    ...
    fn test_timeline_audio_events() {
        ...
        let audio_starts: Vec<_> = timeline.events()
            .iter()
    ...
    fn test_timeline_text_events() {
        ...
        let text_messages: Vec<_> = timeline.events()
            .iter()
