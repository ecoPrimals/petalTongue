...
//! Covers easing functions (all variants, boundary conditions, monotonicity),
//! animation state machine (progress, lerp, delay, completion),
//! player lifecycle (tick, sequence playback, scene graph application),
//! and serialization roundtrips.

use petal_tongue_scene::animation::AnimationTarget;
use petal_tongue_scene::animation::{Animation, AnimationPlayer, AnimationState, Easing, Sequence};
