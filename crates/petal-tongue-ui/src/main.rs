...
fn main() -> Result<(), eframe::Error> {
    ...
    // SAFETY: We're setting this at startup before any threads are created,
    // and it's read-only after this point. This is safe in single-threaded startup.
    unsafe {
        std::env::set_var("PETALTONGUE_INSTANCE_ID", instance_id.as_str());
    }
