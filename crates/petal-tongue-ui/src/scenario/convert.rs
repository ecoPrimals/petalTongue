...
impl PrimalDefinition {
    ...
    pub fn to_primal_info(&self) -> PrimalInfo {
        ...
        if !self.capabilities.is_empty() {
            ...
            properties.insert("capabilities".to_owned(), PropertyValue::String(caps_json));
        }
...
mod tests {
    ...
    fn test_primal_definition_to_info() {
        ...
        assert_eq!(info.capabilities, vec!["test-cap".to_owned()]);
            ...
            ecosystem: crate::scenario::ecosystem::Ecosystem {
                primals: vec![
                    PrimalDefinition {
                        ...
                        primal_type: "Type1".to_owned(),
                        family: "Family1".to_owned(),
                        status: "healthy".to_owned(),
                        health: 100,
                        confidence: 90,
                    ...
                    PrimalDefinition {
                        id: "p2".to_owned(),
                        name: "Primal 2".to_owned(),
                        primal_type: "Type2".to_owned(),
                        family: "Family2".to_owned(),
                        status: "healthy".to_owned(),
                        health: 95,
                        confidence: 85,
