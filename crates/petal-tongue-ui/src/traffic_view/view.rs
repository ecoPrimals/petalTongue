...
mod tests {
    ...
    #[test]
    fn bezier_control_points_vertical() {
        // When dx is 0 (vertical line), control_offset is 0
    ...
    fn calculate_flow_width_max_volume_zero_no_panic() {
        // When max_volume is 0, implementation uses max(1) to avoid div-by-zero.
        // With zero metrics, should return min_width.
        let m = TrafficMetrics {
            bytes_per_second: 0,
            ..Default::default()
        };
