...
mod output_verification_tests {
    ...
    fn test_output_verification_initial_state() {
        ...
        assert_eq!(verification.state, petal_tongue_core::rendering_awareness::VisibilityState::Unknown);
    }
    ...
    fn test_output_confirmation_via_interaction() {
        ...
        assert!(verification.reaches_user);
        assert_eq!(verification.confirmation_method, OutputConfirmation::UserInteraction);
        assert_eq!(verification.state, petal_tongue_core::rendering_awareness::VisibilityState::Confirmed);
    ...
    fn test_output_confirmation_via_device() {
        ...
        assert!(verification.reaches_user);
        assert_eq!(verification.confirmation_method, OutputConfirmation::DeviceAck);
        assert!(verification.last_confirmed.is_some());
    }
...
mod input_verification_tests {
    ...
    fn test_input_verification_initial_state() {
        ...
        assert_eq!(verification.interactivity, petal_tongue_core::rendering_awareness::InteractivityState::Unconfirmed);
    }
    ...
    fn test_input_recording() {
        ...
        assert!(verification.input_active);
        assert!(verification.from_intended_source);
        assert_eq!(verification.interactivity, petal_tongue_core::rendering_awareness::InteractivityState::Active);
...
mod topology_detection_tests {
    ...
    fn test_visual_topology_detection() {
        ...
        assert!(matches!(
            topology,
            OutputTopology::Direct | OutputTopology::Forwarded | OutputTopology::Nested | OutputTopology::Virtual | OutputTopology::Unknown
        ));
