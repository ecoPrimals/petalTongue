...
pub trait PetalTongueRpc {
    ...
    /// Render graph topology (visualization service)
    ///
...
///
/// Request to render a graph topology visualization.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RenderRequest {
    /// Graph topology data (JSON or binary)
    pub topology: Vec<u8>,
