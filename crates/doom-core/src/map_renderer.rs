...
mod tests {
    ...
    fn test_render_simple_map() {
        ...
        let map = MapData {
            ...
            linedefs: vec![
                LineDef { start_vertex: 0, end_vertex: 1, flags: 1, line_type: 0, sector_tag: 0 },
                LineDef { start_vertex: 1, end_vertex: 2, flags: 1, line_type: 0, sector_tag: 0 },
                LineDef { start_vertex: 2, end_vertex: 3, flags: 1, line_type: 0, sector_tag: 0 },
                LineDef { start_vertex: 3, end_vertex: 0, flags: 1, line_type: 0, sector_tag: 0 },
            ],
            sectors: vec![],
            things: vec![],
        };
