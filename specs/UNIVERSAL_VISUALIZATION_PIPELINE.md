...
For inter-primal IPC, **JSON-RPC 2.0 is REQUIRED**; **tarpc MAY** be used for Rust-to-Rust hot paths (e.g., streaming `Bytes`); JSON-RPC covers subscriptions, tooling, and peers without tarpc.
